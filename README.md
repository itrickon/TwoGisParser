...
Парсер данных с платформы ___2GIS___ для сбора информации о предприятиях.
...
2. Скачате Python с официального сайта ([ссылка на сайт](https://www.python.org/))
...
- Откроется приложение **TwoGisParser**:
...
- На рабочем столе появится ярлык **TwoGisParser**
